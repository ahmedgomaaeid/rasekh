        ...
        <div class="main-container container-fluid">
            ...
            <div class="row" style="padding-top: 25px;">
                <div class="col-12 col-sm-12">
                    ...
                    @endif
                    <!-- ROW-1 END -->
                    <form method="POST" action="{{route('get.admin.charging-card.export')}}">
                        @csrf
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">تصدير البطاقات</div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="tab-menu-heading border-0 p-0">
                                            <div class="tabs-menu1">
                                                ...
                                                <ul class="nav panel-tabs product-sale">
                                                    <li><a href="{{route('get.admin.charging-card.create')}}" class="active">اضافة بطاقة</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab5">
                                                    <div class="table-responsive">
                                                        <table id="myTable" class="table table-bordered text-nowrap mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="g-2">
                                                                            <a class="btn text-primary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Edit" href="{{route('get.admin.charging-card.edit',$card->id)}}"><span class="fe fe-edit fs-14"></span></a>
                                                                            <a class="btn text-danger btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Delete" href="{{route('get.admin.charging-card.delete',$card->id)}}"><span class="fe fe-trash-2 fs-14"></span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                        ...
                                        <div class="panel-body tabs-menu-body border-0 pt-0" style="height: 500px; overflow:scroll; margin-bottom:30px;">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab5">
                                                    <div class="table-responsive">
                                                        <table id="myTable2" class="table table-bordered text-nowrap mb-0">
                                                            <thead class="border-top">
                                                                <tr>
                                                                    <th class="bg-transparent border-bottom-0">
                                                                        رقم البطاقة</th>
