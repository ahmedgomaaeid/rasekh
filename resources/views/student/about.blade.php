                                                                                                ...
                                                                                                <div class="elementor-image-box-wrapper">
                                                                                                    <div class="elementor-image-box-content">
                                                                                                        ...
                                                                                                        <p class="elementor-image-box-description">
                                                                                                            راسخ هي منصة تعليمية إلكترونية توفر لطلاب المراحل الأساسية والثانوية، وخاصة مرحلة التوجيهي، بيئة تعليمية متطورة تسعى وبأسلوب حديث ومبسط لمساعدة الطلاب في كافة المناطق على النجاح والتفوق في اجتياز امتحان الثانوية العامة.
                                                                                                        </p>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                ...
                                                                                <div class="elementor-column-wrap elementor-element-populated">
                                                                                    <div class="elementor-widget-wrap">
                                                                                        <div class="elementor-element elementor-element-1c6e59f elementor-widget elementor-widget-smartvideo" data-id="1c6e59f" data-element_type="widget" data-widget_type="smartvideo.default">
                                                                                            <div class="elementor-widget-container">
                                                                                                <video id="my-video" class="video-js vjs-big-play-centered" controls preload="auto" style="width:100%" height="370" data-setup="{}">
