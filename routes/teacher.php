        ...
        Route::group(['middleware' => 'teacher.approved'], function () {
            ...
            Route::group(['middleware' => 'teacher.live'], function () {
                ...
                Route::prefix('zoom-meeting')->group(function () {
                    ...
                    Route::get('/upload', 'ZoomMeetingController@upload')->name('get.teacher.zoom-meeting.upload');
                    Route::post('/upload', 'ZoomMeetingController@uploadStore')->name('post.teacher.zoom-meeting.upload');
                });
