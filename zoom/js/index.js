...
function websdkready() {
  ...
  var SDK_KEY = "4NCkw3R5TiGmeeKkk1O4A";
  /**
   ...
   */
  var SDK_SECRET = "3QA7hCwyZ1YKDWXTeSMWfrWeOWna6u0W";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "C:/laragon/www/study/zoom/zoom-sdk-web-2.9.7/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "C:/laragon/www/study/zoom/zoom-sdk-web-2.9.7/CDN/meeting.html?" +
